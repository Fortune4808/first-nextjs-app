    ...
    return (
        <div className="flex flex-col gap-2">
            <div className="w-full flex gap-1">
                <div className="w-[60%] min-h-[120px] bg-white shadow-[0px_0px_12px_2px_rgba(34,34,34,0.06)] flex-grow rounded-md flex justify-center">
                    <div className="w-[95%] flex items-center justify-between text-[#424141]">
                        <div className="flex justify-between items-center gap-2">
                            <div className="w-[80px] h-[80px] rounded">
                                <Image src="/all-images/image-pix/avatar.jpg" width={80} height={80} alt="" title="" className="rounded" />
                            </div>

                            <div className="flex flex-col">
                                <div className="flex justify-center items-center gap-1"><AiOutlineDashboard/>Administrative Dashboard</div>
                                <div className="text-[var(--primary-color)] font-bold">Ogunleye Opeyemi Fortune</div>
                            </div>
                        </div>
                    </div>
                </div>
